...
var category = {OBJ: $("#_JD_ALLSORT"),
		URL_Serv: "http://manage.cdlg.com/rest/api/cat/tree?callback=category.getDataService",
        ...
        return "" == c ? d : (/^http[s]?:\/\/([\w-]+\.)+[\w-]+([\w-.\/?%&=]*)?$/.test(c) || (c = c.replace(/-000$/, ""), c = c.match(/^\d*-\d*$/) ? "http://channel.jd.com/" + c + ".html" : "http://front.cdlg.com" + c + ".html"), '<a href="' + c + '">' + d + "</a>")
