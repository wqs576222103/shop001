...
<div class="w">
    <div id="logo">
    	<a href="http://front.cdlg.com/" clstag="passport|keycount|login|01">
    		<img src="/images/cdlg-logo.gif" alt="羽帆" width="170" height="60"/>
    	</a><b></b>
   	</div>
</div>
<form id="formlogin" method="post" onsubmit="return false;">
    ...
    <div class=" w1" id="entry">
        ...
        <div class="free-regist">
            <span><a href="http://front.cdlg.com/user/register.html" clstag="passport|keycount|login|08">免费注册&gt;&gt;</a></span>
        </div>
    </div>
</form>
<div class="w1">
