...
<!--shortcut end-->
	...
	<div class="w w1 header clearfix">
		<div id="logo"><a href="http://front.cdlg.com/"><img src="/images/cdlg-logo.gif"  alt="羽帆商城" /></a></div>
		...
		<table class="order-table">
			...
			<c:forEach items="${carts }" var="cart">
				  <tr>
				    <td class="fore1">
					   <div class="p-goods">
						  <div class="p-img"><a href="http://front.cdlg.com/item/${cart.itemId}.html" target='_blank'><img width="52" height="52" src="${cart.itemImage}"></a></div>
							 <div class="p-detail">
								<div class="p-name">
